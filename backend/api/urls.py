...
router.register(r"purchase-order", PurchaseOrderAPIView, basename="purchade-order")
...
router.register(r"sale-transactions", SalesTransactionAPIView, basename="transactions")
